...
<%
   ...
   //댓글의 시퀀스 번호 미리 얻어내기
   int seq=SuggestCommentDao.getInstance().getSequence();
   //저장할 댓글의 정보를 dto 에 담기
   SuggestCommentDto dto=new SuggestCommentDto();
   dto.setNum(seq);
   ...
   //댓글 정보를 DB 에 저장하기
   SuggestCommentDao.getInstance().insert(dto);
   //응답하기 (원글 자세히 보기로 다시 리다일렉트 시킨다)
   String cPath=request.getContextPath();
   response.sendRedirect(cPath+"/suggest/detail.jsp?num="+ref_group);
%>
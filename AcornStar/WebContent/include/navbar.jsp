...
<link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet">
	<div class="container-fluid">
		<h1 class="d-flex align-items-center mb-0 ps-5" style="font-family: 'Lobster', cursive; display:inline-block; color: #6610f2;">
			<a id="acornstar" href="javascript:" >
				<span id="star" >
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
         ...
         <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="margin-right: 20px;">
            ...
            <li>
               <div class="m-2">
                  <a href="${pageContext.request.contextPath}/main/main.jsp">
                         <svg xmlns="http://www.w3.org/2000/svg" width="30" height="50" fill="indigo" class="bi bi-house-door-fill" viewBox="0 0 16 16">
            ...
            <li>
               <div class="m-2">
                  <a href="private/chat.jsp">
                       <svg xmlns="http://www.w3.org/2000/svg" width="30" height="50" fill="indigo" class="bi bi-chat-dots" viewBox="0 0 16 16">
            ...
            <li>
               <div class="m-2">
                  <a href="info.jsp">
                     <svg xmlns="http://www.w3.org/2000/svg" width="30" height="50" fill="indigo" class="bi bi-suit-heart" viewBox="0 0 16 16">
            ...
            <li>
               <div class="m-2">
                  <a id="write" href="javascript:">
                     <svg xmlns="http://www.w3.org/2000/svg" width="30" height="50" fill="indigo" class="bi bi-pencil-square" viewBox="0 0 16 16">
            ...
            <li>
               <div class="m-2">
                  <a href="${pageContext.request.contextPath}/user/myProfile.jsp">
                     <svg xmlns="http://www.w3.org/2000/svg" width="30" height="50" fill="indigo" class="bi bi-person-circle" viewBox="0 0 16 16">

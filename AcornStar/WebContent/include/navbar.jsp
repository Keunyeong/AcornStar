...
<link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet">
	<div class="container-fluid">
		<h1 class="d-flex align-items-center mb-0 ps-5" style="font-family: 'Lobster', cursive; display:inline-block; color: #6610f2;">
			<a id="acornstar" href="${pageContext.request.contextPath}/main/main.jsp" >
				<span id="star" >
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
         ...
         <div class="m-2">
            <a class="" id="logout" href="${pageContext.request.contextPath}/user/logout.jsp">
               <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="30px" height="30px" fill="indigo" viewBox="0 0 262.85 262.85" style="enable-background:new 0 0 262.85 262.85; " xml:space="preserve">
